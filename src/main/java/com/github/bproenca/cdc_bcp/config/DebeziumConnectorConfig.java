package com.github.bproenca.cdc_bcp.config;
...
public class DebeziumConnectorConfig {
    ...
    public io.debezium.config.Configuration customerConnector() throws IOException {
        ...
        return io.debezium.config.Configuration.create()
            ...
            .with("topic.prefix", "cstmr")
            .with("schema.history.internal", "io.debezium.storage.file.history.FileSchemaHistory")
            .with("schema.history.internal.file.filename", dbHistoryTempFile.getAbsolutePath())
            //.with("schema.history.internal.kafka.topic", "cstmr-topic")
            //.with("schema.history.internal.kafka.bootstrap.servers", "cstmr-server")
